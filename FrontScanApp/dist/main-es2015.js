...
/* harmony default export */ __webpack_exports__["default"] = ("<block-ui>\r\n    <router-outlet></router-outlet>\r\n</block-ui>");
...
const routes = [
    ...
    { path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_12__["HomeComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrModule"].forRoot({ progressBar: true }),
...
let AuthInterceptor = class AuthInterceptor {
    ...
    intercept(req, next) {
        if (localStorage.getItem('token') != null) {
            ...
            return next.handle(clonedReq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(() => { }, err => {
                if (err.status === 401) {
...
let UserService = class UserService {
    constructor(fb, http, router, toastr) {
        this.fb = fb;
        this.http = http;
        this.router = router;
        this.toastr = toastr;
    ...
    login(formData) {
        ...
        return this.http.post(this.BaseURI + '/ApplicationUser/Login', formData)
            .pipe(
        // this.blockUI.start("Loading..."),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["timeout"])(5000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => {
            this.blockUI.stop();
        }))
            .subscribe((res) => {
            localStorage.setItem('token', res.token);
...
module.exports = __webpack_require__(/*! D:\Work\ScanSystem\ScanSystem\FrontScanApp\src\main.ts */"./src/main.ts");
