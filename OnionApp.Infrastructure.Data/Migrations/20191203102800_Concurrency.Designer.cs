...
namespace OnionApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20191203102800_Concurrency")]
            ...
            modelBuilder.Entity("OnionApp.Domain.Core.Entities.Accounts.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2019, 12, 3, 13, 27, 59, 547, DateTimeKind.Local).AddTicks(6990),
                            IsEnabled = true,
                            RoleName = "admin",
                            RowVersion = 0u
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2019, 12, 3, 13, 27, 59, 549, DateTimeKind.Local).AddTicks(8765),
                            IsEnabled = true,
                            RoleName = "user",
                            RowVersion = 0u
                        });
            ...
            modelBuilder.Entity("OnionApp.Domain.Core.Entities.Accounts.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2019, 12, 3, 13, 27, 59, 549, DateTimeKind.Local).AddTicks(9983),
                            IsEnabled = true,
                            Login = "admin@mail.ru",
                            Password = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2019, 12, 3, 13, 27, 59, 550, DateTimeKind.Local).AddTicks(6414),
                            IsEnabled = true,
                            Login = "tom@mail.ru",
                            Password = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2019, 12, 3, 13, 27, 59, 550, DateTimeKind.Local).AddTicks(6973),
                            IsEnabled = true,
                            Login = "bob@mail.ru",
                            Password = "123456",
                            RoleId = 2,
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2019, 12, 3, 13, 27, 59, 550, DateTimeKind.Local).AddTicks(6977),
                            IsEnabled = true,
                            Login = "sam@mail.ru",
                            Password = "123456",
                            RoleId = 2,
